!(function (e, t) {
  ...
  var ce,
    ...
    Ee = j('wks'),
    Te = l.Symbol,
    Ye = Le ? Te : (Te && Te.withoutSetter) || P,
    Ne = function (e) {
      return (
        S(Ee, e) ||
          (ke && S(Te, e) ? (Ee[e] = Te[e]) : (Ee[e] = Ye('Symbol.' + e))),
        Ee[e]
      );
    },
    Ke = Ne('match'),
  ...
  var Wt =
    ...
    yn = function (e, t) {
      ...
      return (
        $t(n, { type: Mt, tag: e, description: t }), f || (n.description = t), n
      );
    },
    bn = Le
      ? function (e) {
  ...
  if (
    (ke ||
      (ae(
        (nn = function () {
          ...
          return f && hn && pn(tn, t, { configurable: !0, set: n }), yn(t, e);
        }).prototype,
        'toString',
        function () {
          return en(this).tag;
    ...
    He(
      { target: Mt, stat: !0, forced: !ke },
      {
        for: function (e) {
          ...
          var n = nn(t);
          return (dn[t] = n), (fn[n] = t), n;
        },
        keyFor: function (e) {
          if (!bn(e)) throw TypeError(e + ' is not a symbol');
          if (S(fn, e)) return fn[e];
        },
        useSetter: function () {
          hn = !0;
        },
    ...
    He(
      { target: 'Object', stat: !0, forced: !ke, sham: !f },
      {
        create: function (e, t) {
    ...
    ii = function (e, t, n, i, r, o, c) {
      ...
      if (
        ...
        if (((a = { values: l(ei), keys: o ? h : l($n), entries: l(ti) }), c))
          for (u in a) (Mn || f || !(u in g)) && ae(g, u, a[u]);
        else He({ target: t, proto: !0, forced: Mn || f }, a);
      return a;
    },
    ri = kn.charAt,
    oi = 'String Iterator',
  ...
  var ai = function (e) {
    ...
    gi = Ne('iterator'),
    Ii = function (e) {
      if (null != e) return e[gi] || e['@@iterator'] || zn[St(e)];
    },
    hi = Ne('iterator'),
    pi = !1;
  try {
    ...
    { target: 'Array', stat: !0, forced: vi },
    {
      from: function (e) {
        ...
        if (
          ...
          for (n = new a((t = pe(s.length))); t > g; g++)
            (c = d ? l(s[g], g) : s[g]), st(n, g, c);
        else
          for (
            ...
            (c = d ? ui(r, l, [i.value, g], !0) : i.value), st(n, g, c);
        return (n.length = g), n;
      }
    }
  );
  ...
  Li(
    ...
    function (e, t) {
      for (
        var n = Ni.call(Ti(this), e, t),
          i = (function (e, t) {
            var n,
              i = R(e).constructor;
            return void 0 === i || null == (n = R(i)[Ei]) ? t : tt(n);
      ...
      var g = (function () {
        ...
        I = (function (t) {
          ...
          function c() {
            ...
            return (
              e(this, c),
              (t = o.call(this)).listeners || g.call(a(t)),
              ...
              },
              {
                ...
                value: function (e) {
                  'abort' === e.type &&
                    ...
                    f(r(c.prototype), 'dispatchEvent', this).call(this, e);
                }
              }
            ]),
            c
            ...
            if (
              ...
              n && n.close(),
                e.data.response.error
                  ? r(Er.fromPayload(e.data.response))
                  : i(e.data.response),
                clearTimeout(a),
                window.removeEventListener('message', c, !1),
                setTimeout(s, 2e3);
        ...
        (i = function (t) {
          if (t.data && 'authorization_response' === t.data.type) {
            if (
              ...
              return n(Er.fromPayload(t.data.response));
            e(t.data.response);
          }
        }),
    ...
    go = (function () {
      ...
      return (
        ...
        (e.prototype.readJson = function (e) {
          var t,
            n = fo(e, Object.keys(window.localStorage)),
  ...
  var Co = vo.get,
    ...
    Zo = {
      get: function (e) {
        var t = Uo.get(e);
        return t || Uo.get('_legacy_' + e);
      },
      save: function (e, t, n) {
        var i = {};
        'https:' === window.location.protocol && (i = { secure: !0 }),
          (i.expires = n.daysUntilExpire),
          Bo('_legacy_' + e, JSON.stringify(t), i),
          Uo.save(e, t, n);
      },
      remove: function (e) {
        Uo.remove(e), Uo.remove('_legacy_' + e);
      }
    },
    So = {
      get: function (e) {
  ...
  var Go,
    ...
    Ao =
      ...
      (wo = !1),
      function (e) {
        return (xo = xo || Vo(Go, Xo, wo)), new Worker(xo, e);
      }),
    Ro = {},
    Qo = new Jr(),
    Jo = 'auth0.lock.getTokenSilently',
    Wo = {
      memory: function () {
    ...
    Lo = (function () {
      function e(e) {
        ...
        if (
          ...
          (this.cookieStorage = !1 === e.legacySameSiteCookie ? Uo : Zo),
      ...
      return (
            ...
            r(this, void 0, void 0, function () {
              ...
              return o(this, function (f) {
                switch (f.label) {
                  ...
                  case 1:
                    if ((a = f.sent())) return [2, a];
                    f.label = 2;
                  case 2:
                    return [
                      4,
                      ((g = function () {
                        return Qo.acquireLock(Jo, 5e3);
                      }),
                      (I = 10),
                      void 0 === I && (I = 3),
                      r(void 0, void 0, void 0, function () {
                  ...
                  case 3:
                    if (!f.sent()) return [3, 15];
                    f.label = 4;
                  case 4:
                    return f.trys.push([4, , 12, 14]), t ? [3, 6] : [4, s()];
                  case 5:
                    if ((a = f.sent())) return [2, a];
                    f.label = 6;
                  case 6:
        ...
        (e.prototype._getTokenFromIFrame = function (e) {
          return r(this, void 0, void 0, function () {
            var t, r, c, s, a, u, l, d, f, g, I, h, p, y, b;
            return o(this, function (o) {
              switch (o.label) {
                case 0:
  ...
  function Eo(e) {
    return r(this, void 0, void 0, function () {
      ...
      return o(this, function (n) {
        switch (n.label) {
          case 0:
            return [4, (t = new Lo(e)).checkSession()];
          case 1:
            return n.sent(), [2, t];
        }
      });
  ...
  var To = Eo;
  return (To.Auth0Client = Lo), (To.createAuth0Client = Eo), To;
}),
  'Auth0Client' in this &&
    this.console &&
    this.console.warn &&
